        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/70 rounded-2xl p-8 border border-gray-700/50 backdrop-blur-sm shadow-xl">
              ...
              <div className="space-y-6">
                ...
                <div 
                  ...
                  className="flex items-center space-x-4 group cursor-pointer p-3 rounded-lg hover:bg-gray-700/30 transition-all duration-300"
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 font-medium group-hover:text-burgundy-400 transition-colors">
                      abdelarahma510@gmail.com
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/70 rounded-2xl p-8 border border-gray-700/50 backdrop-blur-sm shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Name Field */}
              <div>
                <label htmlFor="name" className="block text-sm font-sans-elegant font-medium text-gray-400 mb-2">
                  Your Name
                </label>
                <input
                  type="text"
              ...
              {/* Email Field */}
              <div>
                <label htmlFor="email" className="block text-sm font-sans-elegant font-medium text-gray-400 mb-2">
                  Email Address
                </label>
                <input
                  type="email"
              ...
              {/* Message Field */}
              <div>
                <label htmlFor="message" className="block text-sm font-sans-elegant font-medium text-gray-400 mb-2">
                  Your Message
                </label>
                <textarea
                  id="message"
